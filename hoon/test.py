...
def nt_header_info (pe) :
    ...
    nt_header_list.append(["SizeOfCode", hex(pe.OPTIONAL_HEADER.SizeOfHeaders), "IMAGE_SCN_CNT_CODE 속성을 갖는 섹션들의 총 사이즈 크기"])
