...
# 수정본 v0.2
# num of pid (270) + error code (1)
# return rist of size 271 
...
def main():
    ...
    for arg in sys.argv[1:]:
        ...
        if error < 0:
            ...
            a = rich['cmpids']
            for b in a:
                dict_rich[ b['pid']] = b['cnt']
            return dict_rich

# 각 pid가 딕셔너리의 key가 되고, cnt가 value가 되도록,
# 마지막 271번째 value는 애러코드
# 총 271 크기의 리스트가 리턴되는데 기존 신경쓰지 못했던 애러에 대해서도
# 학습 가능할 것으로 예상
